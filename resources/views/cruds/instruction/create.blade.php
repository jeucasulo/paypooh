          ...
          <div class='col-md-12'>
            ...
            <form id='saveForm' class='form-horizontal' role='form' method='POST' action='{{route("cruds.instruction.store")}}' enctype='multipart/form-data'>
              ...
              <div class='form-group{{ $errors->has("title") ? " has-error" : "" }}'>
                ...
                <div class='col-md-6'>
                  <input id='title' type='text' class='form-control' name='title' placeholder='Título da instrução'>
                  @if ($errors->has("title"))
                  <span class='help-block text-danger'>
              ...
              <div class='form-group{{ $errors->has("body") ? " has-error" : "" }}'>
                ...
                <div class='col-md-6'>
                  <input id='body' type='text' class='form-control' name='body' placeholder='Sobre a plataforma'>
                  @if ($errors->has("body"))
                  <span class='help-block text-danger'>
              ...
              <div class='form-group{{ $errors->has("user_id") ? " has-error" : "" }}'>
                ...
                <div class='form-group{{ $errors->has("platform_id") ? " has-error" : "" }}'>
                  ...
                  <div class='col-md-6'>
                    <input id='platform_id' type='text' class='form-control' name='platform_id' placeholder='text/binary' value="{{$platform->id}}" readonly>
                    @if ($errors->has("user_id"))
                    <span class='help-block text-danger'>
                      <strong>{{ $errors->first("platform_id") }}</strong>
                    </span>
